      ...
      <div className="bg-[#EBEBEB] dark:bg-[#2A2A2A] w-[90%] max-w-[480px] p-8 rounded-[2.5rem] shadow-2xl relative max-h-[95vh] overflow-y-auto scrollbar-hide transition-colors duration-300">
        ...
        <div className="flex flex-col gap-4 mb-6">
          ...
          <div className="relative">
            <select value={categoria} onChange={(e) => setCategoria(e.target.value)} className="appearance-none w-full bg-white dark:bg-[#1A1A1A] rounded-full px-6 py-3.5 text-base text-gray-700 dark:text-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#7C3AED] cursor-pointer transition-colors duration-300">
