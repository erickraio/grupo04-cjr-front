...
import { User, LogOut, ShoppingCart } from 'lucide-react'; // Adicionado o ícone de carrinho aqui
            ...
            <div className="flex items-center">
                {logado ? (
                    <div className="flex items-center gap-6">
                        {/* Ícone do Carrinho (visível quando o usuário está logado) */}
                        <button 
                    ...
                    <div className="flex items-center gap-6">
                        {/* Ícone do Carrinho também visível mesmo se não estiver logado */}
                        <button 
                            onClick={() => router.push('/carrinho')}
                            className="text-white transition-colors cursor-pointer hover:text-gray-300 mr-2"
                            title="Carrinho"
                        >
                            <ShoppingCart size={20} strokeWidth={2} />
                        </button>
