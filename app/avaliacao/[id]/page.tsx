...
export default function TelaAvaliacaoIdentica() {
  ...
  return (
    ...
    <div className="bg-[#f6f3e4] min-h-screen flex flex-col font-sans">

      <Navbar />



      <div className="bg-[#000000] text-white pt-24 pb-16 px-8 flex justify-center w-full shadow-md">

        <div className="w-full max-w-[900px] flex flex-col gap-6 relative">

          <button onClick={() => router.back()} className="absolute -left-12 top-2 hover:opacity-70 transition text-2xl font-bold">‹</button>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <div
                ...
                className="w-14 h-14 rounded-full overflow-hidden bg-gray-600 flex-shrink-0 cursor-pointer hover:opacity-80 transition"
          ...
          <p className="text-xl font-light text-gray-200 pl-2 leading-relaxed">{dados?.comentario || "Sem comentário principal."}</p>
      ...
      <div className="flex-1 flex flex-col items-center py-12 px-8 w-full">
        ...
        <div className="w-full max-w-[800px] flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6 pl-6 border-l-2 border-gray-300/40">
...
{listaDeComentarios.map((sub) => {
  ...
  return (
    ...
    <div key={sub.id} className="flex flex-col gap-2 bg-white/40 p-4 rounded-2xl shadow-sm relative">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <div
            ...
            className="w-10 h-10 rounded-full overflow-hidden bg-gray-300 cursor-pointer hover:opacity-80 transition"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-900 text-base">{sub.usuario?.nome || "Usuário"}</span>

              {foiEditado && (

                <span className="text-[10px] text-gray-400 font-medium uppercase tracking-wider italic">editado</span>
        ...
        {idUsuarioLogado === sub.id_usuario && (
          ...
          <button onClick={() => abrirModalEditarComentario(sub)} className="w-[24px] h-[24px] bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition">
      ...
      <p className="text-gray-700 text-base font-light pl-13 mt-1 whitespace-pre-wrap">{sub.comentario}</p>
            ...
            {listaDeComentarios.length === 0 && (
              ...
              <p className="text-gray-400 italic text-center py-4">Nenhum comentário por aqui ainda.</p>
          ...
          <div className="mt-6 w-full">
            ...
            {idUsuarioLogado ? (
              ...
              <form onSubmit={handleAdicionarComentario} className="w-full bg-white rounded-full px-6 py-4 shadow-sm flex items-center justify-between border border-gray-200">

                <input type="text" value={novoComentario} onChange={(e) => setNovoComentario(e.target.value)} placeholder="Adicionar comentário..." className="w-full bg-transparent outline-none text-gray-700 font-light placeholder-gray-400 text-base" />

                <button type="submit" className="text-[#6A38F3] hover:opacity-70 transition pl-2">
              ...
              <div className="w-full py-4 text-center text-gray-500 italic bg-white/60 rounded-full border border-gray-200 shadow-sm">Você precisa estar logado para comentar...</div>
      ...
      {modalEditComentarioOpen && (
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-[#ebebeb] w-full max-w-[650px] rounded-[2.5rem] p-10 flex flex-col items-center gap-6 relative shadow-2xl">
            ...
            <button onClick={() => setModalEditComentarioOpen(false)} className="absolute top-6 right-6 text-black hover:opacity-60 text-3xl font-light">✕</button>



            <div className="w-full mt-4 bg-white rounded-2xl p-6 min-h-[220px] shadow-inner flex flex-col">

              <textarea value={textoComentarioEditar} onChange={(e) => setTextoComentarioEditar(e.target.value)} placeholder="Comentário" className="w-full flex-1 outline-none resize-none text-gray-700 text-base font-light" />
            ...
            <div className="w-full flex flex-col gap-4 mt-2 px-12">
              ...
              <button onClick={handleSalvarComentarioEditado} className="w-full py-3 bg-[#6A38F3] text-white font-semibold rounded-full shadow-lg text-sm tracking-wider uppercase hover:opacity-90 transition">Salvar</button>
